...
# CONSTANTS
RULES_FILE = "ForeignWordsAnalytics/PyBulStem/rules/stem_rules_context_2_UTF-8.txt"
MIN_RULE_FREQ = 2
MIN_WORD_LEN = 3
...
def stem(word):
	...
	for _ in word:
		...
		#This is Angel's shit
		if word_reminder not in (0, 12) and word_reminder < 20:
		# This is Angel's shit
...
try: StemmingRules = pickle.load(open('ForeignWordsAnalytics/venv/PyBulStem/rules/StemmingRules-MinFreq-'+str(MIN_RULE_FREQ)+'.pickle', 'rb'))
